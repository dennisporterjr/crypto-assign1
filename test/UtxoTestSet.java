...
/**
 * test.UtxoTestSet represent a random created data test set for testing isValid and txHandler methods.
 ...
 * 
 * A test.UtxoTestSet can be
 * constructed wit by means of a builder:
 * 
 * <pre>
 * test.UtxoTestSet.builder()
 * 	.setPeopleSize(10)
 * 	.setUtxoTxNumber(10)
...
public class UtxoTestSet {
	...
	/**
	 * Factory method that constructs a new builder of test.UtxoTestSet
